...
(function () {
    ...
    option = {
        ...
        legend: {
            data: ['ایمیل', 'تبلیغات اتحادیه', 'تبلیغات ویدیویی', 'مستقیم', 'موتور جستجو'],
            textStyle: {
              color: '#777'
            }
        },
    ...
    option = {
        ...
        xAxis: {
            ...
            data: ['مجموع', 'اجاره', 'آب و برق', 'حمل و نقل', 'غذاها', 'سایر'],
            axisLine: {
                lineStyle: {
                    color: "#8c9097"
                }
    ...
    option = {
        ...
        yAxis: {
            type: 'category',
            data: ['برزیل', 'اندونزی', 'ایالات متحده آمریکا', 'هند', 'چین', 'جهان'],
            axisLine: {
                lineStyle: {
                    color: "#8c9097"
                }
        ...
        series: [
            {
                ...
                radius: '50%',
                data: [
                    { value: 1048, name: 'موتور حستجو' },
                    { value: 735, name: 'مستقیم' },
                    { value: 580, name: 'ایمیل' },
                    { value: 484, name: 'تبلیغات' },
                    { value: 300, name: 'ویدیو' }
                ],
                emphasis: {
                    itemStyle: {
                        shadowBlur: 10,
    ...
    option = {
        ...
        xAxis: {
            data: ['1390-10-24', '1390-10-25', '1390-10-26', '1390-10-27'],
            splitLine: {
                lineStyle: {
                    type: 'dashed',
                    color: "rgba(142, 156, 173,0.1)"
    ...
    option = {
        ...
        radar: {
            indicator: [
                ...
                { name: 'تکنولوژی', max: 30000 },
                { name: 'پشتیبانی', max: 38000 },
                { name: 'توسعه دهنده', max: 52000 },
                { name: 'بازاریابی', max: 25000 }
            ]
        },
        series: [
            {
    ...
    option = {
        ...
        legend: {
            data: ['نمایش', 'کلیک', 'بازدید', 'استعلام', 'سفارش'],
            textStyle: {
              color: '#777'
            }
        },
        series: [
            {
                ...
                data: [
                    { value: 60, name: 'بازدید' },
                    { value: 40, name: 'هدف' },
                    { value: 20, name: 'سفارش' },
                    { value: 80, name: 'کلیک' },
                    { value: 100, name: 'نمایش' }
                ]
            }
        ],
        color: ["rgb(84, 109, 254)", "rgb(175 ,109, 237)", "rgb(244, 167, 66)", "rgb(221 ,58, 82)", "rgb(12, 163, 231)"]
    ...
    function makeOption(type, symbol) {
        return {
            ...
            yAxis: {
                data: ['گوزن شمالی', 'کشتی', 'هواپیما', 'قطار', 'ماشین'],
                inverse: true,
                axisLine: { show: false },
                axisTick: { show: false },
                axisLabel: {
