    ...
    function dropdownHeaderTemplate(suggestions) {
        ...
        <header data-selector='tagify-suggestions-header' class="${this.settings.classNames.dropdownItem} ${this.settings.classNames.dropdownItem}__addAll">
            <strong style='grid-area: add'>${this.value.length ? `افزودن` : 'افزودن همه'}</strong>
            <span style='grid-area: remaning'>${suggestions.length} مورد</span>
            <a class='remove-all-tags'>حذف همه</a>
        </header>
    `
    }
