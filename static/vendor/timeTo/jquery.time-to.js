...
(function (factory) {
    ...
    var defaults = {
        ...
        width: 60,               // width of a digit area
        height: 104,              // height of a digit area
    ...
    $.fn.timeTo = function () {
        ...
        return this.each(function () {
            ...
            if (!data.vals) {
                ...
                data.height = Math.round((data.fontSize * 100) / 93 * 2 + 1) || data.height;
                data.width = Math.round((data.fontSize * 0.8) + (data.height * 0.13) + 8) || data.width;
                ...
                left = Math.round(data.height / 10 + 15);
                ulhtml = '<ul style="left:' + left + '%; top:-' + data.height + 'px"><li>0</li><li>0</li></ul></div>';
                style = data.fontSize
                ...
                dot2 = '<span>:</span>';
                maxWidth = Math.round((data.width * 2) + 3 + 30);
                ...
                if (data.displayDays > 0) {
                    ...
                    for (i = data.displayDays - 1; i > 0; i -= 1) {
                        dhtml += i === 1
                            ? dhtml2.replace('">', 'margin-right:0">')
                            : dhtml2;
                    }

                    if (data.displayDays === 1) {
                        dhtml = dhtml.replace('">', 'margin-right:0">');
                    }

                    thtml = (data.displayCaptions
                        ? '<figure style="width:' + ((data.width * data.displayDays - 7) + marginRight + 4) + 'px">$1'
                            + '<figcaption style="' + fsStyleVal + 'padding-right:0">'
